...
### Changed
- Hide pause injection settings (inject on pauses, pause duration, pause sensitivity) when hotkey mode is **hold**
- Pause-based streaming is disabled in hold mode; transcription inserts on key release only
